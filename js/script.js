...
monogatari.script({
	...
	"Welcome-Center-2-Choice": [
		...
		// Decide whether to watch the video or the exhibits
		{
			Choice: {
				Dialog:
					"k:normal Oh! Let's go this way! We can see a video about the Tajima Yahei Sericulture Farm.",
	...
	"Welcome-Center-2-Video": [
		...
		{
			Choice: {
				Dialog: "k:normal Yes! Now do you want to go see some of his things?",

				Yes: {
					Text: "Sure, let's go see the exhibits.",
					Do: "jump Welcome-Center-2-Exhibits",
				},
				No: {
					Text: "No, that's OK.",
	...
	"Welcome-Center-2-Exhibits": [
		...
		{
			Choice: {
				Dialog: "k:normal Now, do you want to see the video?",

				Yes: {
					Text: "Yes, let's go see the video.",
					Do: "jump Welcome-Center-2-Video",
				},
				No: {
					Text: "No, that's OK.",
					Do: "jump Welcome-Center-2-Final",
				},
			},
		},
	],
	...
	"Welcome-Center-2-End": [
		{
			Choice: {
				...
				No: {
					Text: "No, that's OK.",
					Do: "jump Welcome-Center-2-Final",
					// Need some logic about learning all the stuff or not.
				},
			},
		},
	],
